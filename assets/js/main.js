var Zepto = function() {
    ...
    function d(t, e, n) {
        for (E in e) n && (o(e[E]) || Y(e[E])) ? (o(e[E]) && !o(t[E]) && (t[E] = {}), Y(e[E]) && !Y(t[E]) && (t[E] = []), d(t[E], e[E], n)) : e[E] !== w && (t[E] = e[E])
    }
    ...
    return X.matches = function(t, e) {
        ...
        var r, i, a;
        return _.test(t) && (r = j(P.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(D, "<$1></$2>")), e === w && (e = Z.test(t) && RegExp.$1), e in I || (e = "*"), a = I[e], a.innerHTML = "" + t, r = j.each(N.call(a.childNodes), function() {
            a.removeChild(this)
        ...
        if (!t) return X.Z();
        if ("string" == typeof t)
            if (t = t.trim(), "<" == t[0] && Z.test(t)) r = X.fragment(t, RegExp.$1, n), t = null;
            else {
                if (n !== w) return j(n).find(t);
                r = X.qsa(P, t)
            }
        else {
            if (e(t)) return j(P).ready(t);
            if (X.isZ(t)) return t;
            if (Y(t)) r = s(t);
            else if (i(t)) r = [t], t = null;
            else if (Z.test(t)) r = X.fragment(t.trim(), RegExp.$1, n), t = null;
            else {
                if (n !== w) return j(n).find(t);
                r = X.qsa(P, t)
            }
    ...
    }, j.contains = P.documentElement.contains ? function(t, e) {
    ...
    }, j.camelCase = k, j.trim = function(t) {
        ...
        ready: function(t) {
            return J.test(P.readyState) && P.body ? t(j) : P.addEventListener("DOMContentLoaded", function() {
                t(j)
            }, !1), this
        },
        get: function(t) {
        ...
        removeClass: function(t) {
            return this.each(function(e) {
                if ("className" in this) {
                    ...
                    C = y(this), g(this, t, e, C).split(/\s+/g).forEach(function(t) {
                        C = C.replace(l(t), " ")
                    }), y(this, C.trim())
                }
            })
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var t = this.offsetParent || P.body; t && !$.test(t.nodeName) && "static" == j(t).css("position");) t = t.offsetParent;
                return t
            })
        }
        ...
        j.fn[e] = function() {
            ...
            return o.length < 1 ? this : this.each(function(t, e) {
                ...
                var s = j.contains(P.documentElement, i);
    ...
    }), X.Z.prototype = j.fn, X.uniq = S, X.deserializeValue = b, j.zepto = X, j
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
    ...
    function(t) {
        ...
        k.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
            ...
            r(i), i.crossDomain || (n = y.createElement("a"), n.href = i.url, n.href = n.href, i.crossDomain = k.protocol + "//" + k.host != n.protocol + "//" + n.host), i.url || (i.url = window.location.toString()), h(i);
            var p = i.dataType,
                d = /\?.+=\?/.test(i.url);
        ...
        t.fn.simpleJekyllSearch = function(e) {
            ...
            function r(e) {
                ...
                return t.each(c, function(t, r) {
                    for (var t = 0; t < s.length; t++) void 0 !== r[s[t]] && r[s[t]].toLowerCase().indexOf(e.toLowerCase()) !== -1 && (n.push(r), t = s.length)
                }), n
            }
    ...
    function(t, e, n) {
        t("a#slide").click(function() {
            ...
            if (32 == t.keyCode && t.target == document.body) return t.preventDefault(), !1
        }, t(document).keydown(function(e) {
            if (!t(".search-form").hasClass("active")) switch (e.key) {
                case " ":
                    t("a#slide").trigger("click");
                    break;
                case "Escape":
                    t("#fade").trigger("click")
            }
            if (t("#sidebar").hasClass("slide")) switch (e.key) {
                case "1":
                    t("#sidebar ul:first-child li:first-child a").trigger("click");
                    break;
                case "2":
                    t("#sidebar ul:first-child li:nth-child(2) a").trigger("click");
                    break;
                case "3":
                    t("#sidebar ul:first-child li:nth-child(3) a").trigger("click");
                    break;
                case "4":
                    t("#sidebar ul:first-child li:nth-child(4) a").trigger("click");
                    break;
                case "5":
                    t("#sidebar ul:first-child li:nth-child(5) a").trigger("click");
                    break;
                case "g":
            ...
            if (t(".search-form").hasClass("active")) switch (e.key) {
                case "Esc":
                    t(".icon-remove-sign").trigger("click")
            }
        });
        var r = {
